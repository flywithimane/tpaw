...
window.onload = function () {
    ...
    fetch('https://api.openweathermap.org/data/2.5/weather?q='+_city.name+'&units=metric&lang=fr&APPID=4fd2186e9803f107711bff13c152159e')
...
window.onload = function () {
    ...
    fetch('https://api.openweathermap.org/data/2.5/weather?q='+_city.name+'&units=metric&lang=fr&APPID=c0a3aa331653aeb3c205dcae6e61ca9b')
        .then(function(response) {
